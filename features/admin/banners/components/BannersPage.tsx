...
import type { Banner } from "@/features/admin/_shared/lib/admin.types";
    ...
    <div className="px-8 pt-7 pb-12">
      <div className="flex items-center justify-between mb-[18px]">
        <div>
          ...
          <div className={A.title}>
            {banners.filter((b) => b.status === "activo").length} banners activos
          </div>
        </div>
        <Button
          variant="accent"
      ...
      <div className="grid gap-4 grid-cols-[repeat(auto-fill,minmax(320px,1fr))]">
        {banners.map((b) => (
          <div
            key={b.id}
            className="overflow-hidden bg-card border border-[var(--bd)]"
          >
            <div className="h-[150px] relative">
              <div className="stripe-fig absolute inset-0" />
              <div className="absolute inset-0 flex flex-col justify-center pl-6 bg-gradient-to-r from-black/55 to-black/15">
                ...
                <div className="font-display font-extrabold text-[12px] tracking-[1px] uppercase px-3 py-[5px] mt-[10px] w-fit bg-[var(--gold)] text-black">
                  {b.cta} →
                </div>
              </div>
            ...
            <div className="px-[18px] py-4">
              ...
              <div className="flex justify-between py-1.5 text-[13px]">
                ...
                <span className="font-display font-extrabold text-[var(--gold)]">{b.clicks.toLocaleString()}</span>
              </div>
