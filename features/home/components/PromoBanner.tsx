export function PromoBanner() {
  ...
  return (
    <div className="bg-(--gold) text-black py-[11px] overflow-hidden">
      <div className="animate-marquee flex whitespace-nowrap">
        {doubled.map((item, i) => (
          <span key={i} className="font-display text-[13px] font-bold tracking-[2.5px] uppercase px-7 inline-flex items-center gap-3.5">
