  ...
  return (
    <section className="glow-section shell py-14 md:py-20">
      <div className="relative z-1 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-6 md:mb-8">
        ...
        <Link
          href="/catalogo"
          className="hover:text-accent-ink transition-colors duration-200 font-display inline-flex items-center text-[15px] font-bold tracking-[1px] uppercase no-underline border-b border-transparent pb-0.5 text-muted"
        >
          Ver todos
