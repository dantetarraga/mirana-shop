...
export function PreorderSection() {
  return (
    <section className="px-12 py-[80px]">
      <div className="mb-8">
        <div className="text-[10px] font-bold tracking-[3px] uppercase text-[var(--gold)] mb-[10px]">Disponibles pronto</div>
        ...
        {[
          ...
          <div key={p.name} className="bg-card border border-[var(--bd)] cursor-pointer">
            <div className={`${p.cat} h-[200px] relative flex items-center justify-center`}>
              <div className="absolute top-3 left-0 bg-[var(--gold)] text-black text-[9px] font-extrabold tracking-[2px] uppercase px-[10px] py-[5px]">{p.badge}</div>
            ...
            <div className="p-5">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-[11px] text-muted border border-[var(--bd)] px-[10px] py-1 tracking-[1px] uppercase">
                  Llegada {p.arrival}
                </div>
              </div>
