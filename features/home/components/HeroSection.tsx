  ...
  return (
    <section className="min-h-screen relative overflow-hidden flex items-center px-12 pt-[var(--nh)]">
      ...
      <div className="relative z-[2] max-w-[580px]">
        ...
        >
          Colecciona<br />
          lo <em className="not-italic block text-[var(--gold)]">Extraordinario</em>
        </h1>
        ...
        <div
          className="flex gap-9 mt-[52px] pt-8 border-t border-[var(--bd)]"
        >
          {[
            { n: "500+", l: "Productos" },
            ...
            <div key={l}>
              <div className="font-display text-[40px] font-black leading-none text-[var(--gold)]">{n}</div>
